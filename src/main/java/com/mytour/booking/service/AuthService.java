...
public class AuthService {
    ...
    public LoginResponse loginUser(LoginRequest loginRequest) {
        ...
        // 1. Xác thực người dùng và Xử lý lỗi xác thực
        try {
            ...
            // Bắt lỗi xác thực thất bại (sai username/password)
    ...
    public User registerUser(RegisterRequest registerRequest) {
        ...
        // 2. BỔ SUNG: Kiểm tra Email đã tồn tại chưa
        ...
        // Mã hóa mật khẩu trước khi lưu (Bắt buộc)
